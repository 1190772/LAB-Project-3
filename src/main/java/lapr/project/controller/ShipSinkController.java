...
public class ShipSinkController {
    ...
    public static double calculateShipSinkController(double mass,double ship_length,double ship_width,int n_containers,double density){
    ...
    public static double pressureController(double mass, double length, double width, double heigth){
