CREATE OR REPLACE FUNCTION Loaded_container_next_port (idEmployee employee.id_employee%type) RETURN loaded_container
IS
c_count integer;
invalidID exception;
loaded_container char;
...
SELECT Cargo_Manifest.id_container,Cargo_Manifest.position_code,Container.id_equipment INTO loaded_container
    FROM Employee, Trip, Cargo_Manifest,Ship,Loading_Cargo_Manifest,Container
    ...
    AND Cargo_Manifest.id_container = Loading_Cargo_Manifest.id_container
