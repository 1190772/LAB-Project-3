create or replace PROCEDURE ViewOccupancyRate(id_warehouse warehouse.id_warehouse%type, occupancy_rate IN OUT number, fill IN OUT integer )
AS
...
containersIn integer;
containersOut integer;
containersInB integer;
containersOutB integer;
