...
| Step 2 | ... presenting the available options? | SearchShipUI | IE: is responsible for user interactions. |
| Step 3 | ... temporarily saving the chosen type? | SearchShipController | IE: is responsible for US coordination. |
| Step 4 | ... asking for the required data? | SearchShipUI | IE: is responsible for user interactions. |
| Step 5 | ... finding the ship? | SearchShip | IE: Has the means to so. |
| Step 6 | ... knowing the information of the ship? | Ship | IE: Owns all its attributes. |
| Step 6 | ... showing the ship details to the user? | SearchShipUI | IE: is responsible for user interactions. |             
